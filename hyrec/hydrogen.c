...
- Added additional ionization and excitations due to additional energy injection.
  dEdtdV_dm is the rate of energy deposition rate per unit volume (in eV/s/cm^3)
***************************************************************************************************/
...
double rec_TLA_dxHIIdlna(double xe, double xHII, double nH, double H, double TM, double TR,
   ...
   double ion, exc;
   ion = dEdtdV_dm/nH/EI;  /* dxe/dt due to additional energy injection */
   exc = dEdtdV_dm/nH/E21;                     /* total rate of excitation to the n=2 state */
...
int populateTS_2photon(double Trr[2][2], double *Trv[2], double *Tvr[2], double *Tvv[3],
   ...
   double A2p_up, A2p_dn, rescale2g, rescalediff, dm_exc_frac, pbh_exc_frac;
   double *Aup, *Adn;
  ...
  /****** 2s row and column ******/
   ...
   sr[0]    += 0.25 *(dm_exc_frac + pbh_exc_frac);
   ...
   sr[1]    += 0.75 *(dm_exc_frac + pbh_exc_frac);
...
December 2014: added dependence on additional energy injection dEdtdV_dm in eV/s/cm^3.
